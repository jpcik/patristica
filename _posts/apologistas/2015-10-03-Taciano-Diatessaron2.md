...
{%subcomment'El envío de profetas'%}
...
{%subcomment'La Unción del Verbo'%}
...
{%subcomment'Judas, la venta de Cristo y la compra del campo a un alfarero'%}
...
{%subcomment'La superación de la Ley'%}
...
{%subcomment'La salvación en Jesucristo'%}
...
{%heading'CONCLUSIÓN (cc. 98-100)'%}

### &nbsp;

{%subcomment'A modo de conclusión'%}
...
{%subcomment'Las desviaciones de los herejes'%}
...
{%subcomment'Hay que mantenerse lejos del error'%}
